...
// error gain
float K11 = 1700; // 2300 2400 2200 2350
float K21 = 1200; // 1000 1500

// pitch/roll-dot gain
float K12 = 90; //  120 110  140  140
float K22 = 90; // 50 40 90

// phidot gain (taken from servo speed?)
float K13 = 2.4; // 1.5 3 2.4
float K23 = 1.6; // 0.8 1.6
...
// Wheel axial error
float Kp1 = 0.05; // 0.05
float Ki1 = 0.01; // 0.001 0.005 0.001 0.03 0.05
// 0.015 0.005

// Wheel strafe error
float Kp2 = 0.0035; // 0.001 0.0008 0.0035
...
void ReadOrientation() {
  ...
  while (attempts > 0) {
    if (getIMUData()) {
      pitch = floattodecimal(data[6], data[7], data[8], data[9]) - pitch_sum*1; // rad
